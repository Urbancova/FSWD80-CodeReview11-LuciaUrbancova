...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <a href="#" class="navbar-brand">&trade;URBAN.LIVE</a>
    ...
    <div class="container">
      <div class="row mt-4">
        ...
        <!-- Main Area Start-->
        <div class="col-sm-8 ">
          <h1>Discover, Experience, Rate!</h1>
          <h1 class="lead">Travel blog - Get the most out of life by Lucia Urbancova</h1>
          <?php
           echo ErrorMessage();
           echo SuccessMessage();
           ?>
          ...
          <div class="card shadow-lg p-3 mb-5 bg-white rounded">
            ...
            <div class="card-body">
             ...
             <!-- APPROVE COMMENT GOES HERE -->
              <span style="float:right;" class="badge badge-secondary text-light">Comments:
        ...
        <div class="col-sm-4">
          <div class="card mt-4 shadow-lg p-3 mb-5 bg-white rounded">
            <div class="card-body">
              <img src="Uploads/cars.jpg" class="d-block img-fluid mb-3" alt="">
              <div class="">
          ...
          <div class="card shadow-lg p-3 mb-5 bg-white rounded">
            ...
            <div class="card-body">
              ...
              <button type="button" class="btn btn-warning btn-block text-center text-white mb-4" name="button">Login</button>
              <div class="input-group mb-3">
                <input type="text" class="form-control" name="" placeholder="Enter your email"value="">
                <div class="input-group-append">
                  <button type="button" class="btn btn-secondary btn-sm text-center text-white" name="button">Subscribe Now</button>
                </div>
              </div>
            </div>
          </div>
    ...
    <footer class="bg-dark text-white">
      <div class="container">
        <div class="row">
          ...
          <p class="text-center small"><a style="color: white; text-decoration: none; cursor: pointer;" href="#" target="_blank"><br>&trade; urban.live</a></p>
           </div>
         </div>
      </div>
    </footer>
